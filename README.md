...
blocked runners will be allowed to close their current file and continue. The individual syncs may be issued
sequentially on the batcher's goroutine (the default) or in separate, parallel goroutines if `sync_bactcher.parallel`
is set to true.
